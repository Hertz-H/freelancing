...
@section('content')
    ...
    <div class="container-fluid py-4 mt-5">
        <div class="page-header min-height-100 border-radius-xl mt-4"
            style="background-image: url('user_dash_assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
            ...
            <div class="row gx-4">
                ...
                <div class="col-auto my-auto">
                    ...
                    <div class="evaluated">
                        ...
                        @for ($i = 0; $i < 5; $i++)
                            @if (floor($data->sal_review_to->avg('rate')) - $i >= 1)
                                {{-- Full Start --}}
                                <i class="fas fa-star text-warning"> </i>
                            @elseif ($data->sal_review_to->avg('rate') - $i > 0)
                                {{-- Half Start --}}
                                ...
                                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2 ">
                                    <div class="d-flex align-items-start flex-column justify-content-center ">
                                        <div class="avatar mr-1 mb-1 ">
                                            <img src={{ $review->sal_project->sal_created_by->image }} alt="kal "
