...
@section('content')
    ...
    <div class="container-fluid mt-2 ">
        <div class="page-header min-height-150 border-radius-xl mt-4 text-center text-white d-flex justify-content-center"
            style="">
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class=" avatar-xl position-relative">
                        <img src=" {{ $data->image }}" alt="profile_image" class="w-90 border-radius-lg shadow-sm">
                    </div>
                </div>
                <div class="col-auto my-auto">
                    ...
                    <div class="border-0 ps-0 pb-0 mt-2">
                        @if ($data->sal_profile->facebook != null)
                            <a class="btn btn-facebook btn-simple mb-0 ps-1 pe-2 py-0 "
                                href="  {{ $data->sal_profile->facebook }}">
                                <i class="fab fa-facebook fa-lg "></i>
                            </a>
                        @endif
                        @if ($data->sal_profile->tweeter != null)
                            <a class="btn btn-twitter btn-simple mb-0 ps-1 pe-2 py-0 "
                                href="  {{ $data->sal_profile->tweeter }}">
                                <i class="fab fa-twitter fa-lg "></i>
                            </a>
                        @endif
                        @if ($data->sal_profile->github != null)
                            <a class="btn btn-instagram btn-simple mb-0 ps-1 pe-2 py-0 "
                                href="  {{ $data->sal_profile->github }}">
                    ...
                    <div class="card-body p-3 p card_custom">
                        ...
                        <ul class="list-group ">
                            <li class="list-group-item border-0 ps-0 pt-0 text-sm "><strong
                                    class="text-dark ">الاسم:</strong> &nbsp;{{ $data->name }}</li>
                            <li class="list-group-item border-0 ps-0 text-sm "><strong
                                    class="text-dark ">الجوال:</strong> &nbsp; {{ $data->sal_profile->phone }}</li>
                            <li class="list-group-item border-0 ps-0 text-sm "><strong
                                    class="text-dark ">الايميل:</strong> &nbsp; {{ $data->email }}</li>
                            <li class="list-group-item border-0 ps-0 text-sm "><strong
                                    class="text-dark ">الدولة:</strong> &nbsp; {{ $data->sal_profile->country }}</li>

                        </ul>
                    </div>
                </div>
            </div>
            {{-- @if (!isset($data->sal_skills)) --}}
                    ...
                    <div class="card-body p-3 p card_custom">
                        <ul class="list-group ">
                            ...
                            @forelse($data->sal_skills as $skill)
                                <li
                                    class="list-group-item border-0 d-flex  justify-content-between align-items-center mb-1">
                            ...
                            @empty
                                <li
                                    class="list-group-item border-0 d-flex  justify-content-between align-items-center mb-2 ">
                            ...
                            <div class="row ">
                                    ...
                                    <div class="card h-100 card-plain border ">
                                        <div class="card-body d-flex flex-column justify-content-center text-center ">
                                            <a href="/works/create ">
                                                ...
                                                <h6 class=" text-secondary "> إضافة عمل جديد </h6>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                @forelse($data->sal_works as $work)
                                    <div class="col-xl-3 col-md-6 mb-xl-0 mb-2   "
                                        style='box-shadow: 0 0 1px grey;
                                                                                                                                                                                        border-radius: 1rem;'>
                                        <div class="card card-blog card-plain ">

                                            <div class="col-md-4 text-start d-flex justify-content-end align-items-baseline "
                                                style="width: 100%">
                                                <a class="btn btn-link pe-3 ps-0 mb-0  "
                                                    href="/works/{{ $work->id }}">
                                                ...
                                                <button type="button" class="btn btn-link pe-3 ps-0 mb-0  "
                                                    data-bs-toggle="modal" data-bs-target="#cancel{{ $work->id }}">
                                                    <i class="fa fa-trash  text_primary"></i>
                                                </button>
                                            </div>
                                            ...
                                            <div class="modal fade" id="cancel{{ $work->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">حذف العمل
                                                            </h5>
                                            ...
                                            <div class="position-relative ">
                                                <a class="d-block shadow-xl border-radius-xl ">
                                                    <img src="{{ $work->file }}" alt="img-blur-shadow "
