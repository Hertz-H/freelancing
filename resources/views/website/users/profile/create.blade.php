                ...
                <div class="card">
                    ...
                    <div class="card-body pt-4 p-3">
                        <form method="POST" action="/profiles" enctype="multipart/form-data">
                            ...
                            @csrf
                            <h5 class="mb-0 text-dark ">اكمل بيانات الملف الشخصي: </ا>
                                ...
                                <div class="login_icon_box">
                                    <div class="profile-pic">
                                        ...
                                        <img src={{ asset('images/user_avatar.png') }} id="output" width="200">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-6 col-lg-3">
                                        ...
                                        <input value="" name="birth_date" type="date" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                    ...
                                    <div class="card-header pb-0 px-3 mb-4">
                                        <h6 class="mb-0 text-primary">وسائل التواصل الاجتماعي</h6>
                                    </div>
                                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                        <label for="exampleInputEmail1" class="form-label"> حساب Facebook </label>
                                        <input value="" name="Facebook" type="فثءف" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <input value="" name="tweeter" type="text" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <input value="" name="github" type="text" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <input value="" name="major" type="text" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <input value="" name="Job_title" type="text" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                    ...
                                    <div class="user-box mb-3 col-sm-12 col-md-6 col-lg-4">
                                        ...
                                        <div class="w-100">
                                            ...
                                            @if ($errors->has('skills'))
                                                <small id="emailHelp"
                                                    class="form-text">{{ $errors->first('skills') }}</small>
                                            @endif
                                        </div>
                                ...
                                <div class="col-12  d-flex justify-content-evenly gap-5" role="group"
