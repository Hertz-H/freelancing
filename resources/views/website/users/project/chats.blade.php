                    ...
                    <div class="card m-0">
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                @if ($type == 0)
                                    <a href="{{ route('chats_complaint', $project_id) }}"><button
                                            style="color:black ;border:none" type='submit ' class="note"> شكوى
                                        </button></a>
                                @endif
                                        ...
                                        @foreach ($chat as $data)
                                            @if (Auth::user()->id == $data->sender_id)
                                                <li class="chat-left">
                                                    ...
                                                    <div class="chat-hour">{{ $data->created_at }}<span
        ...
        channel.bind('chat', function(data) {
            ...
            if (current_user == data.sender_id) {
                ...
                var html = ' <li class="chat-right">' +
                    ...
                    ' <div class="chat-name">' + data.sender_name + '</div><div class="chat-hour">' + output +
