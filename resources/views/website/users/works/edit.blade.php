            ...
            <div class="col-md-12 mt-4">
                <div class="card">
                    ...
                    <div class="card-body pt-4 p-3">
                        <form method="POST" action="{{ route('works.update', $data['id']) }}"
                            ...
                            <div class="login_icon_box">
                                <div class="profile-pic">
                                    ...
                                    <img src={{ $data->file }} id="output" width="200">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <input value="{{ $data->link }}" name="link" type="url" class="form-control"
                                        id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                <div class="mb-3 col-sm-12 col-md-6 col-lg-12">
                                    ...
                                    <input value="" name="files[]" type="file" multiple class="form-control"
                                        id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                <div class="mb-3 col-sm-12 ">
                                    ...
                                    <textarea id="face" name="description" type="text" class="form-control" rows="5">{{ $data->description }}</textarea>
