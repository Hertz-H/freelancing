        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            <div class="">
                ...
                <div class="flex flex-col sm:flex-row ">
                    ...
                    <div
                        class="sm:w-full sm:pl-8 sm:py-1 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                            ...
                            <div class="bg-white w-full p-8 rounded">
                                ...
                                <header class="flex  text-sm text-right justify-end mt-2">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 rotate-90 -ml-2"
                                        viewBox="0 0 24 24" stroke="#219EBC">
                                ...
                                @forelse($data as $item)
                                    ...
                                    <h3 class="font-bold text-xl text-right mt-8"> سبب الرفض </h3>
                                    <p class="text-right">
